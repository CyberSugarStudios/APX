...
(function () {
    ...
    const NOTES = [{
        version: 'v2026.9.24.1654',
        released: '2026-09-24T16:54:00',
        releasedText: 'September 24, 2026 · 4:54 PM',
        title: 'Playtest Update',
        intro: 'Our playtests shaped this whole update. GMs can set their world\'s rules, equip NPCs with gear and consumables, and create magic items that change almost anything on a character sheet. Players get Luck and Looting, trading, Loyal Companions who fight at their side, and a dice roller that keeps the combat log. Your characters and worlds update themselves when opened: nothing is lost, and any rule change that touched your character is explained.',
        index: [
            ['Worlds and Loot', [
                'World Settings: the GM chooses Starting XP, Max GP, starting Cu, and Point Buy or Standard Array for the whole world.',
                'Loot Maker: the GM builds loot with the same forges and crafters players use, including consumables, and can equip NPCs with it. NPCs use their consumables in a fight and drop what\'s left when they fall.',
                'Magic items: equippable items can raise or lower any number of things on your sheet: Core Attributes, skills, Max HP, AP, Initiative, Wound Threshold, Rest Dice, Luck Points, Power Slots, attacks, saves and more.',
                'Loot is handed out from the Loot panel, an NPC\'s window or any Area Circle it stands in, and players can trade items among themselves.'
            ]],
            ['For Players', [
                ...
                'In a world, XP comes from the GM with your own bonuses applied.'
            ]],
            ['At the Table', [
                'Dice and Notifications collects every roll, the combat log and your messages in one tray.',
                'The combat log shows the fight to everyone and resolves Wound Threshold and Bleed Out rolls in order. The party\'s damage to enemies appears without numbers, so DR and ER stay hidden.',
            ...
            ['And More', [
                ...
                'See the Character Sheet and GM Tools for everything in detail.'
            ]]
        ],
        sheet: [
            ['Your World', [
                'Your GM sets the rules of the world: Starting XP, Max GP, starting Cu, and how attributes are chosen. A brand-new character gets the Starting XP and Cu once.',
                'XP arrives from your GM with your bonuses (INT modifier, Educated, Expertise) already added, and the XP fields are locked while you\'re in the world. Outside a world, XP and Max GP are yours to set.',
                'Standard Array: each attribute starts on "Choose". A value you pick leaves the other dropdowns until you free it again. Use 7, 6, 5, 5, 5, 4 and 3 once each.',
                'Point Buy: every attribute starts at 4 and you have 7 points. Each +1 costs a point, each −1 returns one, and attributes stay between 2 and 7.'
            ]],
            ['Magic and Custom Items', [
                'Equippable items can carry any number of bonuses (or penalties, for cursed items): Core Attributes, any skill, AC, DR, ER, resistance to a single energy type, Max HP, Max AP, Speed, Initiative, Wound Threshold, Max Rest Dice, Max Luck Points, Carry Capacity, melee and ranged attack and damage rolls, power attack rolls and save DC, saving throws, checks, and extra Power Slots of any level (or for the CHA pool).',
                'Build them with Add Item (tick Equippable, then add Other Bonuses alongside attribute, skill and energy bonuses), and edit your own items later from their details.',
                'Every bonus applies while the item is equipped, and its effects are listed right under the item\'s name in your inventory.',
                'Items from your GM keep the bonuses the GM gave them: you can see them, but not change them.'
            ]],
            ['Party', [
                'The Party tab lists everyone in your world, with each Loyal Companion right after its owner.',
                'Click a portrait to see the whole picture rather than the round token.'
            ]],
            ['Luck and Looting', [
                'Loot / Scavenge (beside + Add Item) holds all three rolls.',
                'Currency: LUC (Loot) × enemies defeated, halved and rounded down, is what the party finds. A 16 against twelve mercenaries uncovers 96 Cu.',
                'Ammunition: LUC (Loot) − 3d6 is how many rounds (or arrows or energy cells) you recover, added to your Light, Medium or Heavy Ammo.',
                ...
                'Spend Luck or an Omen on these rolls and your finds update to match.',
                'When the GM calls for a Loot check, the Currency roll opens with the enemy count filled in and your result goes to the GM.'
            ]],
            ['Trading and Gifts', [
                'Every inventory item has a Give button listing your party. Pick who gets it (and how many, for stacks) and it moves to their inventory.',
                'Gear, consumables, magic items and Cu from your GM arrive in your inventory with a notification.'
            ]],
            ['Loyal Companions', [
                'Give your companion its own picture: upload one, then drag and zoom it inside the circle to frame the token. Adjust re-frames it anytime, and clicking the token shows the whole picture.',
                'Your companion fights beside you. The GM can add it to initiative, and its HP stays in step with your sheet.',
                'Every Rest Die you use also heals your companion by the roll plus its CON modifier. The Short Rest window shows its HP, and you can keep spending dice for it while you\'re at full HP.',
                'A Full Rest restores its Power Slots and charges; so does a Short Rest if its powers use CHA.',
            ...
            ['Action Points', [
                'AP is 6 + half your AGI modifier (rounded down, minimum 6), minus Fatigue, plus any item bonuses.',
            ...
            ['Dice and Notifications', [
                'One tray holds rolls and messages: rest results, XP, loot, HP changes from the GM and warnings. A red dot on the dice button means something new, and cleared entries stay cleared.',
                'In combat the tray becomes the fight\'s log. Damage enemies deal to you shows the amount; damage the party deals to enemies doesn\'t, keeping their DR and ER hidden. Your checks and saves reach the GM, and Luck rerolls update them.',
                'Wound Threshold and Bleed Out: when a hit goes past your Wound Threshold, your next CON save is the roll to avoid being Wounded. If you\'re Bleeding Out too, the CON (Survive) check after it sets how many rounds you have.',
                ...
                'Build a dice pool with the d4–d100 buttons, add a modifier in the box, and press Roll (the pool clears afterwards).',
            ...
            ['Rules', [
                ...
                'Fortunate Fighter Rank 1: use LUC instead of AGI for your AC. The sheet takes the higher.',
            ...
            ['Inventory and Display', [
                'Ammo is a single stack per type: another bundle adds 20 rounds to your "Medium Ammo".',
                ...
                'Small text is larger everywhere, and a touch larger again in the Fantasy theme.'
            ]],
            ['Battle Maps', [
        ...
        gm: [
            ...
            ['Loot Maker', [
                'Make loot with the tools players use: the Weapon Forge and Armor Forge (free for you, finishing with "Add to Loot"), the Consumable Crafter (potions, grenades, scrolls and more), the Adventuring Gear list, quick custom weapons, Shields and Helmets.',
                'Custom items can be made equippable with any number of bonuses or penalties, chosen from one list: Core Attributes, any skill, AC, DR, ER, a single energy resistance, Max HP, Max AP, Speed, Initiative, Wound Threshold, Max Rest Dice, Max Luck Points, Carry Capacity, attack and damage rolls, power attack and DC, saving throws, checks, and extra Power Slots of any level or for the CHA pool.',
                'Players see a GM-made item\'s bonuses on their sheet but can\'t edit them.',
                'Open the Loot Maker from the Loot panel to fill your Loot list, or from an NPC to stock what that NPC carries.'
            ]],
            ['NPC Gear and Consumables', [
                ...
                'Consumables appear on the stat block with their charges and a Use button: 3 AP and one charge, tracked per creature in initiative, so goblins sharing one stat block each have their own.',
                ...
                'An NPC\'s window has its own Loot section: a "Give to" dropdown per item and a Currency box you can give to one player or split across the party, for loot that changes hands without a fight.'
            ]],
            ['Loot on Maps', [
                'Loot lives on NPCs. Link an NPC to an Area Circle and the area\'s popup shows its loot, ready to hand out. A chest, a fallen soldier or a shopkeeper is simply an NPC you place there.',
            ...
            ['Loot After a Fight', [
                ...
                'Choose a party member beside each item and press Give; it goes straight into their inventory. Your other choices stay put while you hand things out, and ✕ removes anything that didn\'t survive the fight.',
            ...
            ['Party', [
                ...
                'Loyal Companions sit under their owner in the Party panel with their stat block, token art and a + Initiative button. Add Party places their tokens on the map too.',
            ...
            ['NPC Crafter', [
                ...
                'Die-step and extra-dice buttons switch off at their maximum, so clicks never fall through to what\'s behind them.',
