...
(function () {
    ...
    const NOTES = [{
        version: 'v2026.9.24.0805',
        released: '2026-09-24T08:05:00',
        releasedText: 'September 24, 2026 · 8:05 AM',
        ...
        index: [
            ['Combat', [
                'The dice roller is now "Dice and Notifications": messages that used to pop up (rests, XP, warnings) appear there instead, and Clear really clears them.',
        ...
        sheet: [
            ...
            ['Dice Roller', [
                'It\'s now called Dice and Notifications: rest results, XP you receive, HP changes from the GM and warnings show up here instead of popping up. A red dot on the dice button means something new. Cleared entries stay cleared.',
            ...
            ['Conditions and Injuries', [
                'While Unconscious, Paralyzed or Incapacitated, your attacks and powers show why (for example "(Unconscious)") and can\'t be rolled. Unconscious also auto-fails STR, AGI, PER, INT and CHA checks (CON checks still work, for your Bleed Out roll); Paralyzed auto-fails STR and AGI checks.',
                'Burning now deals its 1d10 Fire damage automatically at the start of your turn in combat (ignoring ER), unless you\'re immune to Fire.',
            ...
            ['XP', [
                'The Spend XP window now has an XP Log: what you gained (reason, session, date and bonuses) and what you spent it on.',
        ...
        gm: [
            ['Initiative and Combat', [
                'End Combat checks for players who are still Bleeding Out first, and the log notes when the last enemy falls while someone is still bleeding. The XP award is the last line of the combat log.',
                'Messages that used to pop up now go to Dice and Notifications (Wound Threshold reminders included).',
                'Saved NPC stat blocks keep their current HP in step with a higher max HP, and NPCs added to initiative start at full HP.',
