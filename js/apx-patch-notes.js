...
(function () {
    ...
    const NOTES = [{
        version: 'v2026.9.25.0815',
        released: '2026-09-25T08:15:00',
        releasedText: 'September 25, 2026 · 8:15 AM',
        title: 'Playtest Update',
        intro: 'This update is built on what our playtest tables asked for. GMs can set world rules, outfit NPCs with gear and consumables, and craft magic items that can change nearly anything on a character sheet. Players get Luck and Looting, trading, Loyal Companions at their side, Omen dice that can bend other creatures\' fates, and a dice roller that doubles as the combat log. Characters and worlds update when you open them. Nothing is lost, and anything a rule change touched is explained.',
        index: [
            ['Worlds, Loot and Magic Items', [
                'World Settings: the GM picks Starting XP, Max GP, starting Cu, and Point Buy or Standard Array for the whole world.',
                'Loot Maker: the GM creates loot with the same forges and crafters players use, including consumables, and can give it to NPCs. NPCs use their consumables in a fight and drop what\'s left when they fall.',
                'Magic items can raise or lower any number of things on a sheet: Core Attributes, skills, Max HP, AP, Initiative, Wound Threshold, Rest Dice, Luck Points, Power Slots, attacks, saves and more.',
                'Loot is handed out from the Loot panel, an NPC\'s window or any Area Circle the NPC stands in, and players can trade among themselves.'
            ]],
            ['For Players', [
                ...
                'Omen: pass a stored die to the GM for any creature\'s roll (a foe\'s critical hit) or to a party member\'s roller, swap natural 1s and 20s into your held dice, and choose which dice to reroll on a Full Rest.',
            ...
            ['At the Table', [
                'Dice and Notifications gathers every roll, the combat log and your messages in one tray.',
                'The combat log shows everyone the fight and resolves Wound Threshold and Bleed Out rolls in order. The party\'s damage to enemies is shown without numbers, keeping DR and ER hidden.',
            ...
            ['Battle Maps', [
                'Shift+drag moves groups of tokens, images can be layered on the map, and M measures distance. Large maps stay smooth.'
            ]],
            ['Rules', [
            ...
            ['Plus', [
                ...
                'Open the Character Sheet or GM Tools for the full details.'
            ]]
        ],
        sheet: [
            ['Your World', [
                ...
                'Standard Array: every attribute starts on "Choose". A value you pick disappears from the other dropdowns until you free it. Use 7, 6, 5, 5, 5, 4 and 3 once each.',
                'Point Buy: all attributes start at 4 with 7 points. Each +1 costs a point, each −1 gives one back, and every attribute stays between 2 and 7.'
            ]],
            ['Omen', [
                ...
                'Give it to the GM to replace any creature\'s d20, such as an enemy\'s critical hit. Or give it to a party member: it appears in their dice roller (even without the Omen perk) and they use it on one of their own rolls, or pass it along again.',
                'On your own rolls, use a die from the roll\'s buttons.',
                'Banking a natural 1 or 20 (Rank 3) is a swap: the natural roll goes into your Omen dice, and the held die you choose to give up becomes this roll (from Rank 2, plus or minus your LUC modifier).',
                'On a Full Rest, choose which of your held Omen dice, if any, to roll again. The rest are kept, and any empty slots are filled. At Rank 5, dice rolled again come back as whichever of 1, 10 and 20 is missing.'
            ]],
            ['Magic and Custom Items', [
                ...
                'Create them with Add Item (tick Equippable, then add Other Bonuses next to the attribute, skill and energy bonuses), and edit your own later from their details.',
                'Bonuses apply while the item is equipped and are listed under its name in your inventory.',
                'Items from your GM keep the bonuses the GM gave them; you can read them but not change them.'
            ]],
            ['Party', [
            ...
            ['Luck and Looting', [
                ...
                'Scavenging takes about an hour with LUC (Loot), PER (Notice), CON (Survive) or INT (Encyclopedia). Searching for Crafting Materials rolls the table for you: 2–10 finds 1d4 Common and 1d4−1 Uncommon, 11–15 adds Rare, 16+ finds more, a natural 20 finds the most, and a natural 1 triggers a trap or hazard.',
                'Luck rerolls and Omens update what you found.',
                'When the GM asks for a Loot check, the Currency roll opens with the enemy count filled in and your result goes to the GM.'
            ]],
            ['Trading and Gifts', [
                'Each inventory item has a Give button listing your party. Pick who gets it (and how many, for stacks) and it moves to their inventory.',
                'Gear, consumables, magic items and Cu from your GM arrive in your inventory with a notification.'
            ]],
            ['Loyal Companions', [
                'Upload a picture for your companion, then drag and zoom it inside the circle to frame the token. Adjust re-frames it any time, and clicking the token opens the full picture.',
                'Your companion fights beside you: the GM can add it to initiative, and its HP stays in step with your sheet.',
                'Each Rest Die you use also heals your companion by the roll plus its CON modifier. The Short Rest window shows its HP, and you can keep spending dice for it while you\'re at full HP.',
            ...
            ['Action Points', [
                ...
                'In combat your pool empties when the fight starts and refills when your turn comes up. Surprised characters get only 1 AP on their first turn.',
            ...
            ['Dice and Notifications', [
                ...
                'In combat the tray is the fight\'s log. Damage enemies deal to you shows the amount; damage the party deals to enemies doesn\'t, keeping their DR and ER hidden. Your checks and saves reach the GM, and Luck rerolls update them.',
        ...
        gm: [
            ...
            ['Omen Dice on Your Rolls', [
                ...
                'The log tells the table the new result and shows you the before and after. If the Omen was meant for something you resolved another way, dismiss it with ✕.'
            ]],
            ['Loot Maker', [
